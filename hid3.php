...
<body>
  ...
  <h1 class="animated fadeInLeft">Metal Halide</h1>
  <p class="animated fadeInLeft"> We keep mostly Venture branded but also Sylvania and Osram. Our dual lamps are<br /> very well priced in today's market. </p>
</div>


<div class="productsearcher5 animated fadeInUp">
<a href="hidmetale.php"><img class="button hvr-grow-shadow" src ="images/Product Searcher/HID/elliptical.png" alt="elliptical"/></a>
</div>

<div class="productsearcher5 animated fadeInUp">
<a href="hidmetalt.php"><img class="button hvr-grow-shadow" src ="images/Product Searcher/HID/tubular.png" alt="tubular"/></a>
</div>
